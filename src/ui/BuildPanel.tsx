...
function BuildingIcon({ type, color }: { type: BuildingType; color: string }) {
  ...
  if (type === 'hospital') {
    return (
      <svg width={w} height={h} viewBox="0 0 48 56" fill="none">
        ...
        {/* Windows */}
        <rect x="14" y="22" width="7" height="7" rx="1" fill="#fff" opacity="0.25" />
        <rect x="27" y="22" width="7" height="7" rx="1" fill="#fff" opacity="0.25" />
        <rect x="14" y="35" width="7" height="7" rx="1" fill="#fff" opacity="0.25" />
        <rect x="27" y="35" width="7" height="7" rx="1" fill="#fff" opacity="0.25" />
        {/* Door */}
        <rect x="19" y="40" width="10" height="10" rx="2" fill="#fff" opacity="0.15" />
      </svg>
    );
  }
  ...
  if (type === 'library') {
    return (
      <svg width={w} height={h} viewBox="0 0 48 56" fill="none">
        ...
        <circle cx="24" cy="14" r="6" fill="#4a8aaa" opacity="0.8" />
        <circle cx="24" cy="14" r="3" fill="#6cc" opacity="0.6" />
        {/* Windows */}
        <rect x="12" y="28" width="7" height="7" rx="1" fill="#fff" opacity="0.25" />
        <rect x="29" y="28" width="7" height="7" rx="1" fill="#fff" opacity="0.25" />
        <rect x="12" y="39" width="7" height="7" rx="1" fill="#fff" opacity="0.25" />
        <rect x="29" y="39" width="7" height="7" rx="1" fill="#fff" opacity="0.25" />
      </svg>
    );
  }
  ...
  if (type === 'transit') {
    return (
      <svg width={w} height={h} viewBox="0 0 48 56" fill="none">
        ...
        {/* Corner pillars */}
        <rect x="8" y="16" width="4" height="12" rx="1" fill="#4a3d70" />
        <rect x="36" y="16" width="4" height="12" rx="1" fill="#4a3d70" />
        {/* Flat roof */}
        <rect x="4" y="12" width="40" height="5" rx="2" fill="#4a3d70" />
        {/* Lines on body */}
        <rect x="12" y="32" width="24" height="2" rx="1" fill="#fff" opacity="0.15" />
        <rect x="12" y="38" width="24" height="2" rx="1" fill="#fff" opacity="0.15" />
        <rect x="12" y="44" width="24" height="2" rx="1" fill="#fff" opacity="0.15" />
      </svg>
    );
  }
  ...
  return (
    <svg width={w} height={h} viewBox="0 0 48 56" fill="none">
      ...
      {/* Beacon cone on top */}
      <polygon points="24,0 30,10 18,10" fill="#aa2222" opacity="0.9" />
      {/* Beacon glow */}
      <circle cx="24" cy="6" r="3" fill="#ff4444" opacity="0.5" />
      {/* Windows */}
      <rect x="18" y="18" width="5" height="5" rx="1" fill="#fff" opacity="0.2" />
      <rect x="25" y="18" width="5" height="5" rx="1" fill="#fff" opacity="0.2" />
      <rect x="18" y="30" width="5" height="5" rx="1" fill="#fff" opacity="0.2" />
      <rect x="25" y="30" width="5" height="5" rx="1" fill="#fff" opacity="0.2" />
    </svg>
  );
}
